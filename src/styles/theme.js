...
const createColor = (objRange) => {
  ...
  [obj[900], obj[800], obj[700], obj[600], obj[500], obj[400], obj[300], obj[200], obj[100], obj[50], obj[40]] = objRange;
  return obj;
};

//Color ranges
// ---------------- 900 ------- 800 ------- 700 ------ 600 ------ 500 ------ 400 ------ 300 ------ 200 ----- 100 ------- 50 ---- custom
...
const greenRange = ['#002000', '#002e01', '#004319', '#005b2d', '#007342', '#008b59', '#22a570', '#45bf88', '#62daa1', '#7ef5ba', '#00cc83'];
